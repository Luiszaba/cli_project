...
def self.new_from_scrape(info_from_scraper)
{title: "some title", date: "date"}

source = self.new(info_from_scraper[:title], info_from_scraper[:date])
source.title = info_from_scraper[:title]
source.date = info_from_scraper[:date]
